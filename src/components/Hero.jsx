...
const Hero = () => {
  ...
  return (
    <section className="min-h-[980px] bg-hero bg-cover bg-right">
      {/* header */}
      <Header />
      <div className="container mx min-h-[980px] flex justify-center items-center">
        {/* text */}
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className="text-[24px] lg:text-[28px] text-white font-primary italic lg:font-medium mb-1"
          >
            {pretitle}
          </motion.div>
          {/* title */}
