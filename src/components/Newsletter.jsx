...
const Newsletter = () => {
  ...
  return (
    <div className="bg-none lg:bg-newsletter lg:px-24 lg:bg-cover lg:h-[222px] lg:bg-center xl:bg-auto">
      <div class="flex flex-col lg:flex-row  justify-between items-center h-full">
        {/* title & subtitle */}
